...
class CashierSalesReportWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.ui.start_date_cashier_sales_input.setDisplayFormat("dd/MM/yyyy")
        self.ui.end_date_cashier_sales_input.setDisplayFormat("dd/MM/yyyy")
    ...
    def show_transactions_data(self):
        ...
        # Get Dates
        start_date = datetime.strptime(self.ui.start_date_cashier_sales_input.date().toString('dd/MM/yyyy'), '%d/%m/%Y')
        end_date = datetime.strptime(self.ui.end_date_cashier_sales_input.date().toString('dd/MM/yyyy'), '%d/%m/%Y')
