...
class CashierSalesReportRepository:
    def __init__(self):
    ...
    def get_transactions_list(self, start_date: datetime, end_date: datetime, search_text: str = None):
        ...
        try:
            ...
            if search_text:
                ...
                transactions_result = self.cursor.execute(sql, (start_date, end_date, search_text, search_text, search_text, search_text, 2))
            else:
                ...
                sql = '''SELECT created_at, transaction_id, payment_rp, payment_method, payment_remarks 
                            ...
                            WHERE created_at BETWEEN ? AND ?
                            AND created_by = ?'''
                transactions_result = self.cursor.execute(sql, (start_date, end_date, 2))
