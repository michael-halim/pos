...
from generals.constants import PERM_R_STOCK_OPNAME, PERM_E_STOCK_OPNAME, PERM_C_STOCK_OPNAME
from generals.messages import ERR_PERM_R_STOCK_OPNAME, ERR_PERM_E_STOCK_OPNAME, ERR_PERM_C_STOCK_OPNAME
...
class StockOpnameService:
    ...
    def create_stock_opname(self, edit_stock_opname_data: EditStockOpnameModel):
        ...
        return self.repository.create_stock_opname(edit_stock_opname_data)
